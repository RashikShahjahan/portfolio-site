    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          <div className="bg-white border-2 border-black rounded-none p-10 hover:bg-black hover:text-white transition-all duration-300 group flex flex-col h-full">
            ...
            <div className="flex justify-between items-center mt-auto">
              ...
              <div className="space-x-4">
                <a href="https://github.com/RashikShahjahan/artsy-fartsy" target="_blank" rel="noopener noreferrer" className="group-hover:text-white/90">GitHub</a>
                <a href="https://artsy.rashik.sh" target="_blank" rel="noopener noreferrer" className="group-hover:text-white/90">Demo</a>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border-2 border-black rounded-none p-10 hover:bg-black hover:text-white transition-all duration-300 group flex flex-col h-full">
            ...
            <div className="flex justify-between items-center mt-auto">
              ...
              <div className="space-x-4">
                <a href="https://github.com/RashikShahjahan/larn" target="_blank" rel="noopener noreferrer" className="group-hover:text-white/90">GitHub</a>
                <a href="https://crates.io/crates/larn" target="_blank" rel="noopener noreferrer" className="group-hover:text-white/90">Demo</a>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border-2 border-black rounded-none p-10 hover:bg-black hover:text-white transition-all duration-300 group flex flex-col h-full">
            ...
            <div className="flex justify-between items-center mt-auto">
              ...
              <div className="space-x-4">
                <a href="https://huggingface.co/Rashik24/Mistral-Instruct-Bangla" target="_blank" rel="noopener noreferrer" className="group-hover:text-white/90">Hugging Face</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <footer className="footer footer-center p-8 text-black border-t-2 border-black mt-8">
        <div className="grid grid-flow-col gap-6">
          ...
          <a href="https://linkedin.com/in/rashik-shahjahan" target="_blank" rel="noopener noreferrer" className="hover:text-black/70 transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
