        ...
        <section className="container mx-auto px-4 lg:px-8 py-10" aria-label="About Me">
          <div className="prose prose-lg max-w-2xl mx-auto border-2 border-black p-6 relative">
            ...
            <p className="text-black/80">
              I am experienced in full-stack development, distributed systems and AI. In my last job I co-invented a patent pending system (<a href="https://patents.google.com/patent/US20230143418A1/en?oq=US-20230143418-A1" target="_blank" rel="noopener noreferrer">patent</a>) to process large medical corpora and led a team to build and deploy a metrics monitoring system across 4 clients (e.g. Mayo Clinic, Duke Hospital). More recently, I created a <a href="https://artsy.rashik.sh/" target="_blank" rel="noopener noreferrer">website</a> to demonstrate that <a href="https://blog.rashik.sh/tech/can-ai-learn-to-draw" target="_blank" rel="noopener noreferrer">LLMs can draw</a> and a <a href="https://github.com/RashikShahjahan/sonic-ml" target="_blank" rel="noopener noreferrer">tool</a> to simplify language model training. I am always working on cool projects and <a href="https://blog.rashik.sh/tech" target="_blank" rel="noopener noreferrer">writing</a> about them.
            </p>
