...
const Projects = () => {
  ...
  return (
    <section className="container mx-auto px-4 lg:px-8 mb-16" aria-label="Featured Projects">
      <h2 className="text-3xl md:text-4xl font-bold mb-12 text-center text-nous-yellow terminal-heading" data-text="Featured Projects">
        <span className="text-nous-yellow">Featured</span> <span className="text-nous-blue">Projects</span>
      </h2>
