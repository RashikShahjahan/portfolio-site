    ...
    <article className="nous-card bg-base-100 border-2 border-[#D4A017] rounded-none p-10 hover:bg-nous-blue hover:text-white transition-all duration-300 group flex flex-col h-full">
      ...
      <div className="flex justify-between items-center mt-auto">
        <div className="space-x-4">
          {links.github && (
            <a href={links.github} target="_blank" rel="noopener noreferrer" className="text-nous-yellow group-hover:text-white/90 inline-flex items-center gap-1">
          ...
          {links.demo && (
            <a href={links.demo} target="_blank" rel="noopener noreferrer" className="text-nous-yellow group-hover:text-white/90 inline-flex items-center gap-1">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
          ...
          {links.huggingface && (
            <a href={links.huggingface} target="_blank" rel="noopener noreferrer" className="text-nous-yellow group-hover:text-white/90 inline-flex items-center gap-1">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm-1.218 19l-1.782-1.75 5.25-5.25-5.25-5.25 1.782-1.75 6.968 7-6.968 7z"/>
              </svg>
              Hugging Face
          ...
          {links.blog && (
            <a href={links.blog} target="_blank" rel="noopener noreferrer" className="text-nous-yellow group-hover:text-white/90 inline-flex items-center gap-1">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
